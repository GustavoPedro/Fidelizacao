 ...
 * @author gusta
 */
public class FrmGestaoCartao extends javax.swing.JFrame
{

    /**
     * Creates new form FrmGestaoCartao
     */
    public FrmGestaoCartao()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel6.setText("Adicionar Quantidade:");
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(FrmGestaoCartao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new FrmGestaoCartao().setVisible(true);
            }
        });
    }
